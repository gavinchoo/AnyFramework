...
public class TipsToast extends Toast
{
	...
	public static TipsToast makeText(Context context, CharSequence text, int duration)
	{
		...
		int maxWidth = (int) (180 * MyLayoutAdapter.getInstance().getDensityRatio());
		StringUtil.autoSetTextViewGravity(tv, text.toString(), maxWidth);
		tv.setText(text);
	...
	public void setText(CharSequence s)
	{
		...
		int maxWidth = (int) (180 * MyLayoutAdapter.getInstance().getDensityRatio());
		StringUtil.autoSetTextViewGravity(tv, s.toString(), maxWidth);
		if (tv == null)
		{
			throw new RuntimeException("This Toast was not created with Toast.makeText()");
		}
